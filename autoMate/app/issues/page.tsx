    ...
    <form onSubmit={handleSubmit( async (data)=> 
      ...
      <Table.Root variant= 'surface'>
        ...
        <Table.Body>
          ...
          <Table.Cell>
          <Box maxWidth="150px">
          <TextField.Root size="1" placeholder="White/Black" {...register('color')} />
          </Box>
          </Table.Cell>

          <Table.Cell>
          <Box maxWidth="150px">
            <TextField.Root size="1" placeholder="1-10" {...register('level')}/>
          </Box>
          </Table.Cell>
          <Table.Cell>
          <Box maxWidth="150px">
            <TextField.Root size="1" placeholder="Standard, 360" {...register('variant')} />
          </Box>
          </Table.Cell>
          <Table.Cell>
          <Box maxWidth="150px">
            <TextField.Root size="1" placeholder="Minutes"{...register('clock_limit')} />
          </Box>
          </Table.Cell>
          <Table.Cell>
          <Box maxWidth="150px">
            <TextField.Root size="1" placeholder="Seconds" {...register('clock_increment')}/>
          </Box>
          </Table.Cell>
